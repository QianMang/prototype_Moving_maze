...
public class UIManager : MonoBehaviour {
    ...
    public void DifficultyBtnClick(GameObject sender){
        switch(sender.GetComponent<Text>().text){
            case "First time": GameObject.Find("Difficulty control").GetComponent<Difficulty_control>().difficulty=Difficulty_control.Difficulty.first_time;break;
            ...
            case "Challenger": GameObject.Find("Difficulty control").GetComponent<Difficulty_control>().difficulty = Difficulty_control.Difficulty.Challenger; break;
        }
        SceneManager.LoadScene("GameScene");
    }
