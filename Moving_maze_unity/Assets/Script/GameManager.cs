...
public class GameManager : MonoBehaviour
{
    ...
    public GameObject LandCube_9_5;
   ...
   // GameObject gameCamera;
    ...
    //for the DFS search
    int[,] searchArray = new int[12, 7];//1~n;0;999
    ...
    void initiateDifficulty(){
        ...
        switch(GameObject.Find("Difficulty control").GetComponent<Difficulty_control>().difficulty){
            case Difficulty_control.Difficulty.first_time: landWidth=4;break;
            case Difficulty_control.Difficulty.easy: landWidth = 5; break;
            case Difficulty_control.Difficulty.hard: landWidth = 7; break;
            case Difficulty_control.Difficulty.Challenger: landWidth = 9; break;
        }
    }
            ...
            for (int j = 1; j <= 5;j++){
                if (searchArray[i, j] == 0) {
                    ...
                    if(objectRandom<=block_probability){
                        ...
                        if(objectRandom==1){
                            GameObjectPool.GetInstance().Object_Instantiate(right_arrow, position_x, arrow_y, position_z);
                        }else if(objectRandom==2){
                            GameObjectPool.GetInstance().Object_Instantiate(left_arrow, position_x, arrow_y, position_z);
                        }else if(objectRandom == 3){
                            GameObjectPool.GetInstance().Object_Instantiate(up_arrow, position_x, arrow_y, position_z);
                        }else if(objectRandom==4){
                            GameObjectPool.GetInstance().Object_Instantiate(down_arrow, position_x, arrow_y, position_z);
                        }
                    }
                    //else blank
                }
